...
(function () {
  ...
  const LEGAL = {
    ...
    about:
      '<h2>🥷 אודות StratNinja</h2>' +
      '<p>StratNinja היא פלטפורמה לסוחרי TheStrat, שנבנתה על ידי <b>' + OWNER + '</b> (Strat Ninja) — סורק שוק בזמן אמת בשילוב יומן מסחר אישי, במקום אחד.</p>' +
      '<p>המטרה: לתת לסוחר את הכלים לזהות סטאפים, לנתח את השוק לפי שיטת The Strat, ולעקוב אחרי הביצועים — בצורה מדויקת וללא ניחושים.</p>' +
  ...
  const LINKS = [
    ["about", "אודות"], ["contact", "יצירת קשר"], ["disclaimer", "הבהרה פיננסית"],
