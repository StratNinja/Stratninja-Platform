...
(function () {
  ...
  const LEGAL = {
    ...
    about:
      ...
      '<p>שמי <b>' + OWNER + '</b>, ובקהילה אני מוכר בתור <b>Strat Ninja</b>. אני סוחר וחוקר שוק ההון לפי שיטת <b>TheStrat</b> — גישה שמבוססת על מבנה נרות מדויק, במקום ניחושים ותחזיות.</p>' +
      '<p>את StratNinja בניתי מתוך צורך אמיתי: רציתי כלי <b>אחד</b> שנותן לסוחר את כל התמונה — סריקת שוק, זיהוי תבניות וניתוח ביצועים — בלי לקפוץ בין עשרה מסכים. המטרה שלי פשוטה: לעזור לך לסחור <b>בביטחון, לפי נתונים ולא לפי רגש</b>.</p>' +
      '<p>אני משתף ידע, סטאפים וניתוחים מדי יום ברשתות ובקהילה. בוא נסחור חכם יחד. 🥷</p>' +
