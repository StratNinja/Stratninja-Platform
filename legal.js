...
(function () {
  ...
  const LEGAL = {
    ...
    about:
      ...
      '<p class="about-lead">Strat Ninja נבנה בשביל סוחרים שרוצים להפסיק לנחש ולהתחיל לעבוד עם <b>מבנה, נתונים וסדר פעולה ברור</b>.</p>' +
      '<p>שמי <b>' + OWNER + '</b> — בקהילה: <b>Strat Ninja</b>. סוחר וחוקר שוק ההון האמריקאי לפי שיטת <b>TheStrat</b>: מבנה מחיר ומסגרות זמן, לא ניחושים ותחזיות.</p>' +
      '<h3>הבעיה</h3>' +
      '<p>הדבר הכי קשה במסחר הוא לא הגרף — אלא <b>הרגש</b>. רוב הסוחרים קופצים בין עשרה מסכים, מפספסים סטאפים, ומחליטים מתוך פחד או תאווה.</p>' +
      '<h3>מה האתר נותן לך</h3>' +
      '<ul class="about-list">' +
        '<li>📊 <b>סקירת שוק בזמן אמת</b> — לאן הכסף זורם היום</li>' +
        '<li>🔍 <b>סורק תבניות Strat</b> — סינון לפי טיימפריים, סוג נר, IN FORCE ופילטרים טכניים</li>' +
        '<li>🗂️ <b>סקטורים, גאפרים, מפת S&P 500</b> ומדדי רוחב</li>' +
        '<li>📅 <b>יומן מסחר אישי</b> לניתוח הביצועים שלך</li>' +
      '</ul>' +
      '<p>הכול במסך אחד — בלי לקפוץ בין עשרה אתרים.</p>' +
      '<h3>למה להצטרף לקהילה</h3>' +
      '<p>חדשות בוקר יומיות, לייבים וניתוחים חיים, וקהילה שלא סוחרת לבד. <b>נינג׳ות לא מנחשות — הן פועלות בדיוק.</b></p>' +
